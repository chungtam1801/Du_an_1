...
namespace _3.PL.Views
{
    public partial class Frm_BanHang : Form
    {
        ...
        private void LoadDTG_ChiTietHD(List<ViewQLChiTietHoaDon> lstView)
        {
            ...
            //dtg_HoaDonChiTiet.Columns[0].Name = "Ma";
            //dtg_HoaDonChiTiet.Columns[1].Name = "Ten";
            //dtg_HoaDonChiTiet.Columns[2].Name = "Nsx";
            //dtg_HoaDonChiTiet.Columns[3].Name = "Mau Sac";
            //dtg_HoaDonChiTiet.Columns[4].Name = "LoaiSp";
            //dtg_HoaDonChiTiet.Columns[5].Name = "Kich Thuoc";
            //dtg_HoaDonChiTiet.Columns[6].Name = "Chat Lieu";
            //dtg_HoaDonChiTiet.Columns[7].Name = "So Luong";
            //foreach(ViewQLChiTietHoaDon x in lstView)
            //{
            //    dtg_HoaDon.Rows.Add(x.Ma, x.Ten, x.Nsx, x.MauSac, x.LoaiSp, x.KichThuoc, x.ChatLieu, x.SoLuong);
            //}
        }
        ...
        private void pnl_giohang_Paint(object sender, PaintEventArgs e)
        {

        }

        private void pnl_banhangtructiep_Paint(object sender, PaintEventArgs e)
        {
